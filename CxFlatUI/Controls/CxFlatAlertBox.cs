        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (Type)
            {
                case AlertType.Success:
                    backBrush = new SolidBrush(Color.FromArgb(53, ThemeColors.Success));
                    textBrush = new SolidBrush(ThemeColors.Success);
                    break;
                case AlertType.Warning:
                    backBrush = new SolidBrush(Color.FromArgb(53, ThemeColors.Warning));
                    textBrush = new SolidBrush(ThemeColors.Warning);
                    break;
                case AlertType.info:
                    backBrush = new SolidBrush(Color.FromArgb(53, ThemeColors.Info));
                    textBrush = new SolidBrush(ThemeColors.Info);
                    break;
                case AlertType.Error:
                    backBrush = new SolidBrush(Color.FromArgb(53, ThemeColors.Danger));
            ...
            //graphics.DrawPath(new Pen(textBrush, 2f), back);
